    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-10">
        ...
        <section>
          ...
          <p className="mt-3 text-text-primary dark:text-slate-300">
            We continue to expand Datadoktor Labs' service offerings, from pipeline engineering to observability, building deeper expertise in data systems that scale with our clients.
          </p>
        </section>
